const request = require('request'),
    ...
    ignoreNames = ['RequestError', 'StatusCodeError', 'CaptchaError', 'CloudflareError', 'ParseError', 'ParserError', 'ReferenceError'],
...
function INIT() {
  console.log('\033[90mTarget\033[37m:',workerData.target,'');
  console.log('\033[90mHuman\033[37m:',workerData.opt.cookie,'');
  console.log('\033[90mDelay\033[37m: false');
  console.log('\033[90mRate limit\033[37m:',workerData.opt.ratelimit,'');
  console.log('\033[90mPost Data\033[37m:',workerData.opt.body,'');
        ...
        for (let v = 0; v < 1; v++) {
            ...
            let tryrun = setInterval(() => {
                ...
                if (STATE.firewalls.length >= 1e3) {
                    ...
                    //console.log(STATE.firewalls.length);
                }
            });
        }
    }
